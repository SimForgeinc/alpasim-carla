...
class SessionRequest(_message.Message):
    ...
    camera_specs: _containers.RepeatedCompositeFieldContainer[_sensorsim_pb2.CameraSpec]
    ...
    random_seed: int
    def __init__(self, static_world_map: _Optional[_Union[StaticWorldMap, _Mapping]] = ..., text_prompt: _Optional[_Union[TextPrompt, _Mapping]] = ..., debug_options: _Optional[_Union[DebugOptions, _Mapping]] = ..., camera_specs: _Optional[_Iterable[_Union[_sensorsim_pb2.CameraSpec, _Mapping]]] = ..., initial_frames: _Optional[_Iterable[_Union[Image, _Mapping]]] = ..., rig_to_camera: _Optional[_Iterable[_Union[_common_pb2.Pose, _Mapping]]] = ..., random_seed: _Optional[int] = ...) -> None: ...
